                ...
                <div class="col-sm-6">
                    <div class="contactinfo">
                        <ul class="nav nav-pills">
                            <li><a href="#"><i class="fa fa-phone"></i> 01751554502</a></li>
                            <li><a href="#"><i class="fa fa-envelope"></i>prolaycsediu@gmail.com</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-sm-6">
                ...
                <div class="col-sm-8">
                    <div class="shop-menu pull-right">
                        <ul class="nav navbar-nav">
                            ...
                            <li><a href="{{URL::to('/login-account')}}"><i class="fa fa-lock"></i> Login</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                        ...
                        <ul class="nav navbar-nav collapse navbar-collapse">
                            ...
                            <li class="dropdown"><a href="#">Shop<i class="fa fa-angle-down"></i></a>
                                <ul role="menu" class="sub-menu">
                                    ...
                                    <li><a href="{{URL::to('/login-account')}}">Login</a></li>
                                </ul>
                            </li>
                    ...
                    <div class="carousel-inner">
                        <div class="item active">
                            <div class="col-sm-6">
                                ...
                                <h2>Prolay Mukherjee</h2>
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. </p>
                                <button type="button" class="btn btn-default get">Get it now</button>
                            </div>
                            <?php

                            $publice_slider = DB::table('tbl_slider1')
                                            ->where('publication_status',1)
                                            ->get();

                           foreach ($publice_slider as $v_slider){?>

                            <div class="col-sm-6">

                                 <img src="{{URL::to($v_slider->slider_image)}}" alt="" style="height: 300px;width: 550px" />
                ...
                <div class="left-sidebar">
                   ...
                   <div class="panel panel-default">
                     <div class="panel-heading">
                         ...
                         <a href="{{URL::to('/product_by_categroy/'.$v_categroy->categroy_id)}}">
                                {{$v_categroy->categroy_name}}</a></h4>
                            </div>
                        </div>
                    ...
                    <div class="brands_products"><!--brands_products-->
                       ...
                       foreach ($publice_manufacture as $v_manufacture){?>
                               ...
                               {{$v_manufacture->manufacture_name}}</a></li>   
                        <?php  } ?> 
                            </ul>
                        </div>
                    </div><!--/brands_products-->
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-7">
                     ...
                     <?php
                        $publice_delivery = DB::table('tbl_delivery_man')
                                               ->get();

                       foreach ($publice_delivery  as $v_delivery){?>

                    <div class="col-sm-3">
                        <div class="video-gallery text-center">
                            <a href="#">
                                <div class="iframe-img">
                                    <img src="{{URL::to($v_delivery->delivery_man_image)}}" alt="" style="height: 60px;width: 120px" />
                                </div>
