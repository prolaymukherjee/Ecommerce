...
<head>
    ...
    <link id="base-style" href="{{asset('back/css/style.css')}}css/style.css" rel="stylesheet">
    ...
    <!-- end: Favicon -->
            ...
            <style type="text/css">
            body { background: url("{{URL::to('img/bg-login.jpg')}})" !important; }
        </style>
...
<body>
    ...
    <!-- start: JavaScript-->
        ...
        <script src="{{asset('back/back/js/jquery.chosen.min.js')}}"></script>
