	...
	<div class="navbar">
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<a class="brand" href="index.html"><span>prolay</span></a>
			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a href="{{URL::to('/all-categroy')}}"><i class="icon-envelope"></i><span class="hidden-tablet"> All Categroy</span></a></li>
						<li><a href="{{URL::to('/add-categroy')}}"><i class="icon-tasks"></i><span class="hidden-tablet"> Add Categroy</span></a></li>
						...
						<li>
							...
							<ul>
								...
								class="icon-file-alt"></i><span class="hidden-tablet"> All prodect</span></a></li>
						...
						<li>
							...
							<ul>
								...
								class="icon-file-alt"></i><span class="hidden-tablet"> All Slider</span></a></li>
						...
						<li><a href="chart.html"><i class="icon-list-alt"></i><span class="hidden-tablet">Socal Link</span></a></li>

						<li><a href="{{URL::to('/all-shipping-details')}}"><i class="icon-font"></i><span class="hidden-tablet">All shipping details</span></a></li>

						<li><a href="{{URL::to('/add-delivery')}}"><i class="con-font"></i><span class="hidden-tablet"> Delivery Man</span></a></li>
