						...
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  ...
						  <tbody>
							<tr>
								...
								<td class="center">{{$v_product->categroy_name}}</td>
								...
								<td class="center">
									...
									href="{{URL::to('/unactive_product/'.$v_product->categroy_id)}}">
										<i class="halflings-icon white thumbs-down"></i>  
									</a>
									@else
									<a class="btn btn-success" 
									href="{{URL::to('/active_product/'.$v_product->product_id)}}">
									...
									<a class="btn btn-danger" 
									href="{{URL::to('/delete-product/'.$v_product->product_id)}}">
